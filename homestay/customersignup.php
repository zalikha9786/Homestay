...
<body>
  <div id="main">
    ...
    <div id="content">
        ...
        <h1>OWNER SIGNUP</h1>
        <form action="customersignupfunc.php" method="post">
          <div class="form_settings">
            <p><span>NAME</span><input type="text" name="name" value="" required placeholder="Please insert  full name." /></p>
            <p><span>IC NUMBER</span><input type="number" name="icno" value="icno" required placeholder="Please insert ic number." /><//></p>
            <p><span>TEL.NUMBER</span><input type="number" name="cust_tel" value="cust_tel" required placeholder="Please insert phone number." /><//></p>
            ...
            <p><span>EMAIL</span><input type="text" name="cust_email" value="" required placeholder="Please insert email." /></ /></p>
